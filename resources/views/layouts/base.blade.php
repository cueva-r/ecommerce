<?php const title = "rico's";
const subtitle = 'ecommerce';
?>
...
<body class="home-page home-01 ">
                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Llame: (+51) 924 575 577" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>(+51) 924 575 577</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                            <ul>
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->utype == 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="mi cuenta" href="#">Mi cuenta ({{ Auth::user()->name }})
                                                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                                                </a>
                                                <ul class="submenu currency">
                                                    <li class="menu-item">
                                                        <a title="Dashboard" href="{{ route('admin.dashboard') }}"><i
                                                                class="fa-solid fa-gauge"></i> Dashboard</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Categorías" href="{{ route('admin.categories') }}"><i
                                                                class="fa-solid fa-tags"></i> Categorías</a>
                                                    </li>
                                                    <li class="menu-item">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Administrar categorías de inicio"
                                        ...
                                        @else
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu currency">
                                                    <li class="menu-item">
                                                        <a title="Dashboard" href="{{ route('user.dashboard') }}"><i
                                                                class="fa-solid fa-gauge"></i> Dashboard</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ route('logout') }}"
                                    ...
                                    @else
                                        <li class="menu-item">
                                            <a title="Register or Login" href="{{ route('login') }}">Iniciar sesión</a>
                                        </li>
                                        <li class="menu-item">
                                            <a title="Register or Login" href="{{ route('register') }}">Registrarse</a>
                                        </li>
                                    @endauth
                                @endif
                            </ul>
                ...
                <div class="container">
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-logo-top left-section">
                            <a href="/" title="logo rico's" class="link-to-home"><img
                    ...
                    <div class="primary-nav-section">
                        <div class="container">
                            <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                ...
                                <li class="menu-item">
                                    <a href="about-us.html" class="link-term mercado-item-title">Sobre nosotros</a>
                                </li>
                                <li class="menu-item">
                                ...
                                <li class="menu-item">
                                    <a href="/checkout" class="link-term mercado-item-title">Ir a pagar</a>
                                </li>
                                <li class="menu-item">
                                    <a href="contact-us.html" class="link-term mercado-item-title">Contáctenos</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">Lima - Perú</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">Llame: (+51) 924 575 577</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">ricoabraham879@gmail.com</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            ...
                            <div class="wrap-footer-item">
                                <h3 class="item-header">Llame</h3>
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        <span class="desc">Llámenos al número gratuito</span>
                                        <b class="phone-number">Llame: (+51) 924 575 577</b>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="item-content">
                                    <div class="wrap-newletter-footer">
                                        <form action="#" class="frm-newletter" id="frm-newletter">
                                            ...
                                            <button class="btn-submit">Suscribirse</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-list-item social-network">
                                        <ul>
                                            <li><a href="https://twitter.com/rico_a_2005" class="link-to-item"
                                                    title="twitter" target="_blank">
                                                    <i class="fa-brands fa-x-twitter"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://www.facebook.com/ab.rico.05/?locale=es_LA"
                                                    class="link-to-item" title="facebook" target="_blank">
                                                    <i class="fa fa-facebook" aria-hidden="true"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://github.com/cueva-r" class="link-to-item"
                                                    title="github" target="_blank">
                                                    <i class="fa-brands fa-github"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/a.rico_20/" class="link-to-item"
                                                    title="instagram" target="_blank">
                                                    <i class="fa fa-instagram" aria-hidden="true"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://www.tiktok.com/@a.rico2005" class="link-to-item"
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © <?php echo date('Y'); ?> rico's. Todos los redrechos
                            reservados</p>
                    </div>
    ...
    <script src="https://cdn.tiny.cloud/1/eycv6d1fmy1aovlq0unwuqasp62r8to6d805xscpvnafotn7/tinymce/6/tinymce.min.js"
