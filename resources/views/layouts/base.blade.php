				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Llame: (+51) 924 575 577" href="#" ><span class="icon label-before fa fa-mobile"></span>(+51) 924 575 577</a>
								</li>
							</ul>
						</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											<li><a href="https://twitter.com/rico_a_2005" class="link-to-item" title="twitter" target="_blank">
												<i class="fa-brands fa-x-twitter"></i>
											</a>
										</li>
											<li>
												<a href="https://www.facebook.com/ab.rico.05/?locale=es_LA" class="link-to-item" title="facebook" target="_blank">
													<i class="fa fa-facebook" aria-hidden="true"></i>
												</a>
											</li>
											<li>
												<a href="https://github.com/cueva-r" class="link-to-item" title="github" target="_blank">
													<i class="fa-brands fa-github"></i>
												</a>
											</li>
											<li>
												<a href="https://www.instagram.com/a.rico_20/" class="link-to-item" title="instagram" target="_blank">
													<i class="fa fa-instagram" aria-hidden="true"></i>
												</a>
											</li>
											<li>
												<a href="https://www.tiktok.com/@a.rico2005" class="link-to-item" title="tiktok" target="_blank">
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © <?php echo date('Y') ?> rico's. Todos los redrechos reservados</p>
					</div>
