<div>
    <main id="main">
        <div class="container">
                                    ...
                                    @foreach ($lproducts as $lproduct)
                                        <div class="product product-style-2 equal-elem ">
                                            <div class="product-thumnail">
                                                ...
                                                <div class="wrap-btn">
                                                    <a href="{{ route('product.details', ['slug' => $lproduct->slug]) }}" class="function-link">Ver</a>
                                                </div>
                                            </div>
                                            <div class="product-info">
                                                <a href="#" class="product-name"><span>{{ $lproduct->name }}</span></a>
                                                <div class="wrap-price"><span class="product-price">S/. {{ $lproduct->regular_price }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <!--Product Categories-->
            <div class="wrap-show-advance-info-box style-1">
                <h3 class="title-box">Productos por categorías</h3>
                {{-- <div class="wrap-top-banner">
                    <a href="#" class="link-banner banner-effect-2">
