                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    <div class="group-flash">
                                        <span class="flash-item sale-label">En venta</span>
                                    </div>
                                    <div class="wrap-btn">
                                        <a href="{{ route('product.details', ['slug' => $sproduct->slug]) }}"
                                            class="function-link">Ver</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price">
                                        <ins>
                                            <p class="product-price">S/. {{ $sproduct->sale_price }}</p>
                                        </ins> 
                                        <del>
                                            <p class="product-price">S/. {{ $sproduct->regular_price }}</p>
                                        </del>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="product product-style-2 equal-elem ">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="wrap-price"><span
                                                            class="product-price">S/.{{ $c_product->regular_price }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
