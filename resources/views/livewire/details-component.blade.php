                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-butons">
                            ...
                            <div class="wrap-btn">
                                <a href="#" class="btn btn-compare">Comparar</a>
                                <a href="#" class="btn btn-wishlist">Añadir a los deseos</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="our-services">
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <span class="subtitle">On Oder Over S/. 99</span>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        <b class="title">Devolución del pedido</b>
									...
									<div class="product product-widget-style">
										<div class="thumbnnail">
											<a href="{{ route('product.details', ['slug' => $p_product->slug]) }}" title="{{ $p_product->name }}">
												<figure><img src="{{ asset('assets/images/products') }}/{{ $p_product->image }}" alt="{{ $p_product->name }}">
												</figure>
											</a>
										</div>
								...
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{ route('product.details', ['slug' => $r_product->slug]) }}" title="{{ $r_product->name }}">
											<figure><img src="{{ asset('assets/images/products') }}/{{ $r_product->image }}" width="214"
													height="214" alt="{{ $r_product->name }}">
											</figure>
										</a>
										...
										<div class="wrap-btn">
											<a href="{{ route('product.details', ['slug' => $r_product->slug]) }}" class="function-link">Ver</a>
										</div>
									</div>
									<div class="product-info">
