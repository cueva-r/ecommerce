                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea placeholder="Descripción corta del producto" class="form-control" wire:model="short_description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea placeholder="Descripción del producto" class="form-control" wire:model="description"></textarea>
                                    @error('description')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
