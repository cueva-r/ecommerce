            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/socios/agregar') }}" class="btn btn-primary">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Lista socios</h3>
                            </div>

                            <div class="card-body">
                                <table class="table table-striped" id="socios">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Imágen</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!empty($valor->getImagen()))
                                                        <img src="{{ $valor->getImagen() }}" style="width: 40px">
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/socios/editar/' . $valor->id) }}"
                                                        class="btn btn-outline-primary btn-sm">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="{{ url('admin/socios/eliminar/' . $valor->id) }}"
