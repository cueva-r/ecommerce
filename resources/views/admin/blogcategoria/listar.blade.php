            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/blogcategoria/agregar') }}" class="btn btn-primary">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Lista blog de categorías</h3>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped" id="blogcategoria">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Nombre</th>
                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $valor)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/blogcategoria/editar/' . $valor->id) }}"
                                                        class="btn btn-outline-primary btn-sm">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="{{ url('admin/blogcategoria/eliminar/' . $valor->id) }}"
