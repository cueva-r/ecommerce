    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Agregar un nuevo blog de categoría</h1>
                    </div>
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/blogcategoria/listar') }}" class="btn btn-primary">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nombre blog de categoría <span style="color: red">*</span></label>
                                        <input type="text" class="form-control" value="{{ old('nombre') }}" required
                                            name="nombre" placeholder="Nombre blog de categoría">
                                    </div>
