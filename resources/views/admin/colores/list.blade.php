            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/colores/agregar') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $valor)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/colores/editar/' . $valor->id) }}"
                                                        class="btn btn-outline-primary">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="{{ url('admin/colores/eliminar/' . $valor->id) }}"
